...
const PHASE_TEST_MIGRATION_NAME = 'phase_test_records_v5'
...
const SQL = {
  ...
  createPhaseTestRecords: PHASE_TEST_V5_DDL,
...
const PHASE_TEST_DDL_NORMALIZED = normalizeSql(PHASE_TEST_V5_DDL)
